...
const defaultRequest = {
  ...
  subtitle_style: { font: 'Noto Sans TC', size: 48, color: 'FFFFFF', y_offset: 70, max_line_width: 16, outline_width: 0.1, outline_color: '000000' },
  cover_style: { enabled: false, title: '', title_voice: false, duration: 2, extend_duration: 0, background_type: 'gradient', background_blur: true, gradient_colors: ['FF6B9D', 'FFE66D', '4ECDC4'], background_image: '', title_style: { font: 'Noto Sans TC', size: 48, color: 'FFFFFF', y_offset: 0, max_line_width: 0, outline_width: 2, outline_color: '000000' } },
